...
import evellynImg from "../assets/evellyn.png";

export default function Evellyn() {
  return (
          ...
          <div className="flex flex-col md:flex-row gap-6 items-center">
            ...
            <div>
              <h1 className="text-3xl font-bold text-pink-500">
                Evellyn Dwi Shinta L.A
              </h1>

              <p className="text-gray-600">Mahasiswa Teknologi Informasi</p>
              <p className="text-gray-500 text-sm">Semarang, Indonesia</p>

              {/* BUTTON */}
              <div className="flex gap-3 mt-4">

                <a 
                  href="https://www.linkedin.com/in/evellyn-larasati"
                  target="_blank"
                ...
                <a 
                  href="https://github.com/evellyneee"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 px-5 py-2 rounded-full text-white 
                  bg-gray-800 
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <div className="bg-white p-6 rounded-2xl shadow hover:shadow-xl transition">
            ...
            <p className="text-gray-600 text-justify">
              Saya mahasiswa yang memiliki minat dalam bidang teknologi informasi 
              dan design editing. Saya tertarik untuk memahami dan berkembang dalam perkembangan teknologi yang
          ...
          <div className="bg-white p-6 rounded-2xl shadow hover:shadow-xl transition">
            ...
            <div className="grid grid-cols-2 gap-4 text-gray-600">
              <p><b>Nama:</b> Evellyn Dwi Shinta</p>
              <p><b>Kelas:</b> T2G</p>
              <p><b>Domisili:</b> Semarang</p>
              <p><b>Asal Sekolah:</b> SMA Institut Indonesia</p>
            </div>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white p-6 rounded-2xl shadow">
            ...
            <div className="flex items-center gap-2 text-gray-600 text-sm">
              ...
              elvienshintaanindhita@gmail.com
            </div>
